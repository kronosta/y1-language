...
This means that the short macro can be used in other directives, but it also means that the earlier lines
will be preprocessed again before getting back to preprocessing the lines after this directive.
